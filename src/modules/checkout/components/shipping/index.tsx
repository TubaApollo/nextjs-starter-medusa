...
function formatAddress(address: AddressShape | null | undefined) {
  if (!address) {
    return ""
  }
            ...
            <div data-testid="delivery-options-container">
              <div className="pb-8 md:pt-0 pt-2">
                ...
                <RadioGroup
                  ...
                  onChange={(v) => handleSetShippingMethod(v as string, "shipping")}
                >
            ...
            <div className="grid">
              ...
              <div data-testid="delivery-options-container">
                <div className="pb-8 md:pt-0 pt-2">
                  <RadioGroup
                    value={shippingMethodId}
                    onChange={(v) => handleSetShippingMethod(v as string, "pickup")}
                  >
